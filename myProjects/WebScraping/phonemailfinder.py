# this program extracts all emails and phonenumbers form a copied text, and deletes the rest of text.
# steps  !)copy the text you want, --- Run the program ----- 3) paste the tex anywhere you want
# to desplay in tabular for you need to install pandas  and keep this file in same directyry as python

import re
import pyperclip
import pandas  #(pandas is giving errorinstall it in correct directory, either install pandas in new dirc or copy code in default dir)
import os
...
#print(emailist)
print(lister)
#pandas.DataFrame(lister).to_clipboard(excel=True, header=False, index=False)
